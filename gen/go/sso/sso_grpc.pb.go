...
type AuthClient interface {
	...
	IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsLoginResponse, error)
}
...
func (c *authClient) IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	IsAdmin(context.Context, *IsAdminRequest) (*IsLoginResponse, error)
...
func (UnimplementedAuthServer) IsAdmin(context.Context, *IsAdminRequest) (*IsLoginResponse, error) {
