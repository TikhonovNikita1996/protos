...
func (x *IsLoginResponse) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x0fIsLoginResponse\x12\x19\n" +
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xab\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsLoginResponseB\x17Z\x15tikhonov.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*IsLoginResponse)(nil),  // 5: auth.IsLoginResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	...
	5, // 5: auth.Auth.IsAdmin:output_type -> auth.IsLoginResponse
